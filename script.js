...
let num1 = Number(prompt("Пожалуйста выберите первое число?"));
let num2 = Number(prompt("Пожалуйста выберите второе число?"));
if (num1 > num2) {
...
let num11 = Number(prompt('Выберите число'));
let num22 = Number(prompt('Выберите второе число'));
if (num11 % num22 == 0){
    console.log('false');
} else{
...
if (score1 > 90 || project > 10){
    console.log(100);
} else if (score1 > 75 && project >= 5){
    console.log(90);
} else if (score1 > 50 && project >= 2){
    console.log(50)
} else {
    console.log(0);
}
...
let d1 = Number(prompt('Скольки дневная аренда?'));
if (d1 > 2 && d1 < 6){
...
for (let i = 0; i < 8; i += 2){
    e = Number(prompt('Введите число'));
    eResult = e == 10 ? 'Равно 10' : 'Не равно 10';
    console.log(eResult);
}
